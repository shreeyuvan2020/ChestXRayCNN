...
Then run Main.py through "python Main.py"

Then run "python -m streamlit run app.py" as this is opens the website and is where the inference is run, running the file normally will not work with Streamlit.
